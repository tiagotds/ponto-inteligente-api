...
import com.tiagotds_.pontointeligente.api.repositories.FuncionarioRepository;
...
public class FuncionarioServiceTest {
	...
	public void setUp() throws Exception {
		...
		BDDMockito.given(this.funcionarioRepository.findOne(Mockito.anyInt())).willReturn(new Funcionario());
