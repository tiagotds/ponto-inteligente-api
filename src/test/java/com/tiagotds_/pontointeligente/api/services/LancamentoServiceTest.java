...
public class LancamentoServiceTest {
	...
	public void setUp() throws Exception {
		BDDMockito.given(this.lancamentoRepository.findByFuncionario(Mockito.anyInt(), Mockito.any(PageRequest.class)))
	...
	public void testBuscarLancamentoPorFuncionarioId() {
		Page<Lancamento> lancamento = this.lancamentoService.buscarPorFuncionarioId(1, new PageRequest(0, 10));
